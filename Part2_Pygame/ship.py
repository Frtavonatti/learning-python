...
class Ship:
    def __init__(self, ai_settings, screen):
        ...
        # Use float for smooth movement on X axis
        self.center_x = float(self.rect.centerx)

        self.rect.centery = self.rect.bottom - self.margin # start at the bottom of the screen
        # Use float for smooth movement on Y axis
    ...
    def update(self):
        if self.moving_right and self.rect.centerx < self.screen_rect.right - self.margin:
        ...
        elif self.moving_down and self.rect.centery < self.screen_rect.bottom - self.margin:
            self.center_y += self.speed
